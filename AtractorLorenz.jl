...
# ╔═╡ 6e6cced9-a07d-4c6d-8b51-a658c47d5315
begin
	...
	# Solver usado, Tsit5 RK5
	prob = ODEProblem(lorenz!, u0, tspan, p)
	sol = solve(prob, Tsit5(), saveat=0.001)
	
	# Extraer soluciones para cada variable
	x = getindex.(sol.u, 1)
	y = getindex.(sol.u, 2)
	z = getindex.(sol.u, 3)
...
# ╔═╡ 55bea185-bb22-4412-881f-086fe727e47b
begin
	# Gráfica de las variables en función del tiempo
		plt1 = plot(sol.t, x, label="Convección (x)", xlabel="Tiempo", ylabel="u",  lw=2)
		plot!(plt1, sol.t, y, label="Horizontal (y)", lw=2)
		plot!(plt1, sol.t, z, label="Vertical (z)", lw=2)
		
end

# ╔═╡ 2e9331f3-9cb5-46aa-9a26-c0ca1bbe0ceb
# Gráfica del espacio de fase X-Y
	plt2 = plot(x, y, xlabel="Convección (x)", ylabel="Horizontal (y)",  lw=2)
	

# ╔═╡ d1c9fe78-efde-4260-9a2c-62be60085956
# Gráfica del espacio de fase Y-Z
	plt3 = plot(y, z, xlabel="Horizontal (y)", ylabel="Vertical (z)", lw=2)
	

# ╔═╡ 32c12305-7d7f-4a60-b00e-6443adc46181
# Gráfica del espacio de fase X-Z
	plt4 = plot(x, z, xlabel="Convección (x)", ylabel="Vertical (z)",  lw=2)
	

# ╔═╡ c03e1035-edf4-4336-ada7-de7b616abb91
plt5 = plot(x, y, z, xlabel="Convección (x)", ylabel="Horizontal (y)", zlabel="Vertical (z)",
             lw=2, legend=false,
            size=(800,600))
...
manifest_format = "2.0"
project_hash = "cbdaacd3e16c53acedf0ed4f5de83a09e339dd66"
